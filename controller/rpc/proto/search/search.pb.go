...
func (x *ListData) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
func (x *ListData) GetStartTime() string {
	if x != nil {
		return x.StartTime
	}
	return ""
...
func (x *ListData) GetEndTime() string {
	if x != nil {
		return x.EndTime
	}
	return ""
...
func (x *ListRequest) GetProjectCode() string {
	if x != nil {
...
func (x *ListRequest) GetProductId() int32 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
var file_search_proto_rawDesc = []byte{
	...
	0x22, 0x56, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04,
	...
	0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x4d, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x70, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x22, 0x71, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x52,
	...
	0x6f, 0x74, 0x6f, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x2c, 0x0a, 0x0e, 0x53, 0x65,
	...
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x7b, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x73, 0x65, 0x61, 0x72, 0x63,
...
var file_search_proto_depIdxs = []int32{
	1, // 0: proto.ListResponse.data:type_name -> proto.ListData
	0, // 1: proto.SearchService.Search:input_type -> proto.SearchRequest
	2, // 2: proto.SearchService.List:input_type -> proto.ListRequest
	4, // 3: proto.SearchService.Search:output_type -> proto.SearchResponse
	3, // 4: proto.SearchService.List:output_type -> proto.ListResponse
...
func (c *searchServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.SearchService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSearchServiceServer) List(context.Context, *ListRequest) (*ListResponse, error) {
...
func _SearchService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.SearchService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
